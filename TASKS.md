...
- [ ] Implement yt-dlp audio download to a temporary file for candidate streaming tracks
- [ ] Run Chromaprint `fpcalc` on downloaded streaming audio and persist the resulting fingerprint data
