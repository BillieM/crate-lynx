...
- [ ] Slim down the app shell by reducing sidebar header height, search field padding, section gaps, nav row height, badge size, topbar height, icon frames, and action button sizing while preserving current navigation behavior
